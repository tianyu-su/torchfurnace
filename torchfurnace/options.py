...
class Parser(ArgumentParser):
    ...
    def _add_default(self):
        ...
        self.add_argument('-j', dest='workers', type=int, default=0, help='the number of worker of data loader')
        ...
        self.add_argument('--epochs', default=45, type=int, help='number of total epochs to run')
